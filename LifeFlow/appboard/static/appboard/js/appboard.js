...
const dropdownToggle = document.querySelector('#widgetLibraryMenu')
const dropdownMenu = document.querySelector('#widgetLibraryDropdown');
...
document.addEventListener('click', function(event) {
 ...
 // Close dropdown when clicking the close button inside the dropdown
